...
// Momentum-specific GSAP easing names — registered in src/lib/gsap.ts
// Use these strings as the `ease` parameter in gsap.to() / gsap.from()
export const GSAP_EASE = {
  momentumOut: 'momentum-out', // hero blob morph
  momentumSnap: 'momentum-snap', // sticker pop-in
  momentumGlide: 'momentum-glide', // page transitions
  momentumTick: 'momentum-tick', // Merkle node stepper
} as const

export type GsapEaseName = (typeof GSAP_EASE)[keyof typeof GSAP_EASE]
